...
PATH_RELEASE="${6}"
FILES_IGNORE="${7}"
RSYNC_OPTIONS="--archive --compress --human-readable --progress --delete-after --info=DEL --exclude='.dep/' --exclude='.git*' --exclude='.git/' --exclude='README.md' --exclude='readme.md' --exclude='.gitignore'"
